                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                            <div className="bg-white p-4 rounded-lg shadow-md text-center">
                                <div className='flex align-center justify-center items-center gap-2'>
                                    <svg width="70" height="70" viewBox="0 0 70 70" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <rect x="1" y="1" width="68" height="68" rx="34" stroke="#9CC8FC" stroke-width="2" />
                                        <g clip-path="url(#clip0_699_6793)">
                            ...
                            <div className="bg-white p-4 rounded-lg shadow-md text-center">
                                <div className='flex align-center justify-center items-center gap-2'>
                                    <svg width="70" height="70" viewBox="0 0 70 70" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <rect x="1" y="1" width="68" height="68" rx="34" stroke="#9CC8FC" stroke-width="2" />
                                        <path d="M31.0003 45.667H27.0003C25.5858 45.667 24.2293 45.1051 23.2291 44.1049C22.2289 43.1047 21.667 41.7481 21.667 40.3337V28.3337C21.667 26.9192 22.2289 25.5626 23.2291 24.5624C24.2293 23.5622 25.5858 23.0003 27.0003 23.0003H41.667C43.0815 23.0003 44.438 23.5622 45.4382 24.5624C46.4384 25.5626 47.0003 26.9192 47.0003 28.3337V32.3337M29.667 21.667V24.3337M39.0003 21.667V24.3337M21.667 29.667H47.0003M43.667 39.8577L41.667 41.8577" stroke="#9CC8FC" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                                        <path d="M41.6667 48.3333C45.3486 48.3333 48.3333 45.3486 48.3333 41.6667C48.3333 37.9848 45.3486 35 41.6667 35C37.9848 35 35 37.9848 35 41.6667C35 45.3486 37.9848 48.3333 41.6667 48.3333Z" stroke="#9CC8FC" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                                    </svg>
