    ...
    <div>
      <header className="container mx-auto flex flex-wrap justify-center md:flex items-center justify-center mb-10 mt-9">
        ...
        <div className="hidden md:flex items-center justify-between">
          ...
          {windowWidth > 980 ? (
            <Suspense>
              <form onSubmit={handleSearchSubmit} className="search relative w-full md:w-[294px] md:mr-[12px] lg:w-[294px] lg:mr-0" key={query}>
        ...
        {windowWidth < 980 ?
          <Suspense> <div className="container mx-auto mt-6 flex items-center justify-between p-4" key={query}>
            {/* Поисковая строка */}
