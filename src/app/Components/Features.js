...
const Features = ({ features }) => (
  <div className="grid grid-cols-1 md:grid-cols-3 gap-custom-20">
      ...
      <div key={index} className="bg-white shadow-md rounded-3xl p-5 w-[420px] h-[270px] flex flex-col justify-between font-gilroy">
        <div>
          <div className="flex items-center mb-4">
            ...
            <span className="bg-green-100 text-green-800 h-10 rounded-full px-4 py-1 text-sm font-medium">{feature.title}</span>
          </div>
